...
Para la evidencia en vivo que pide la guía, \texttt{benchmark\_live.py} corre exactamente el mismo benchmark sobre webcam mostrando en pantalla el overlay de FPS/RAM/\texttt{nvidia-smi}/MAC en tiempo real, listo para grabar.
