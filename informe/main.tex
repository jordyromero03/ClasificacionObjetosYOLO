...
% Evitar subtitulos "huerfanos" con poco texto antes de un salto de pagina
\clubpenalty=10000
\widowpenalty=10000
...
Como evidencia en vivo, grabé con \texttt{benchmark\_live.py} corriendo sobre mi propia webcam en los cuatro modos (detección GPU/CPU y super resolución GPU/CPU), con el overlay de FPS/RAM/\texttt{nvidia-smi}/MAC quemado en cada frame. El video está disponible en el enlace listado en "Repositorios del Proyecto".
...
\begin{enumerate}[label={[\arabic*]}]
  ...
  \item Anthropic. (2025). \textit{Claude Sonnet — AI assistant}. \url{https://www.anthropic.com}. \textit{[Apoyo en la investigación de RealPLKSR y en la depuración de CUDA/CMake]}
\end{enumerate}
